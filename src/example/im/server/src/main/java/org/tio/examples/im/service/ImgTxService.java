...
import org.tio.core.ListWithLock;
...
public class ImgTxService {
	...
	public static final String filepath = "/tanyaowu/imgs/tx.txt";
	...
	public static void start() {
		//https://git.oschina.net/tywo45/t-io/raw/master/docs/tchat/tx/B010.jpg
//		List<String> dd = new ArrayList<>();
//		for(int i = 0; i < 43; i++){
//			dd.add("https://git.oschina.net/tywo45/t-io/raw/master/docs/tchat/tx/B"+StringUtils.leftPad((i+1)+"", 3, "0")+".jpg");
//		}
//		for(int i = 0; i < 80; i++){
//			dd.add("https://git.oschina.net/tywo45/t-io/raw/master/docs/tchat/tx/G"+StringUtils.leftPad((i+1)+"", 3, "0")+".jpg");
//		}
...
//		List<String> dd = new ArrayList<>();
//		for(File fi : fs){
//			dd.add("https://git.oschina.net/tywo45/t-io/raw/master/docs/tchat/tx/"+fi.getName());
//		}
//		FileUtil.writeLines(dd, filepath, "utf-8");
	...
	static String[] pags = new String[] { 
			"http://www.mmonly.cc/wmtp/fjtp/list_21_1.html", 
			"http://www.mmonly.cc/wmtp/fjtp/list_21_2.html", 
			"http://www.mmonly.cc/wmtp/fjtp/list_21_3.html", 
			"http://www.mmonly.cc/wmtp/fjtp/list_21_4.html", 
			"http://www.mmonly.cc/wmtp/fjtp/list_21_5.html", 
